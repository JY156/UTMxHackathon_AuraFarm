...
Command: npx gltfjsx@6.5.3 public/models/pump/scene.gltf --types --shadows --keepnames --transform 
Files: public/models/pump/scene.gltf [13.66KB] > C:\Users\user\Desktop\My Files\code\3 hackathon\UTMxHackathon_AuraFarm\frontend\scene-transformed.glb [39.78KB] (-191%)
Author: umcosta79 (https://sketchfab.com/umcosta79)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/water-pump-1gpm-1544dfaf46ea474483a65653b455a592
Title: Water Pump 1GPM
*/
...
export function Pump(props: GroupProps) {
  const { nodes, materials } = useGLTF('models/pump/scene-transformed.glb') as GLTFResult
