        ...
        {isRack && (
          <div className="grid gap-4">
            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              {/* Local Rack Alerts */}
              {(rackNumber === 3 || alerts.some(a => a.target === 'rack' || a.rackId === rackNumber)) && (
                <div className="flex flex-col gap-2 rounded-2xl border border-red-500/30 bg-red-500/10 p-4 text-red-400 animate-pulse">
                  ...
                  <p className="text-[10px] text-red-400/80 leading-relaxed pl-8">
                    Crop Vision AI: 96% confidence // Orange-brown necrotic spots detected on select leaves. Quarantine Rack 3 and prune immediately.
                  </p>
                </div>
              )}
