...
import { TrendingUp, RefreshCw, BrainCircuit, Eye, Flame, AlertTriangle, CheckCircle } from 'lucide-react'
    ...
    <section className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
        ...
        <div className="flex flex-col items-center gap-5 rounded-[32px] border border-white/5 bg-black/40 p-6 backdrop-blur-xl hover:border-white/10 transition-all duration-300">
          ...
          <div className="flex flex-col items-center justify-center w-28 h-28 rounded-3xl border border-white/5 bg-white/5 px-2">
            <h3 className="text-2xl font-black text-white tracking-tight">{daysToHarvest} Days</h3>
            <span className="mt-1 text-[8px] font-black uppercase tracking-wider text-slate-500 text-center">to harvest</span>
