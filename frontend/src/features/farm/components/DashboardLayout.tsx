  ...
  return (
    <div className="flex items-center gap-6 text-[10px] font-medium uppercase tracking-widest text-slate-400">
      ...
      <button
        ...
        className={`flex items-center gap-2 rounded-full border px-3 py-1 transition-all ${autoMode
              ...
              <div className="hud-widget-right flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`group relative flex h-12 w-12 items-center justify-center rounded-2xl transition-all border backdrop-blur-xl ${isListening
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex h-14 w-full items-center gap-4 px-4 rounded-2xl transition-all ${isActive ? 'bg-emerald-500 text-white shadow-[0_0_25px_rgba(16,185,129,0.5)]' : 'text-slate-400 hover:bg-white/5'
                          }`}
                      >
...
// ... existing code above ...
          ...
          {/* ✅ ADD THIS CENTERED OVERLAY HERE - Right before ToastSystem */}
          <AnimatePresence>
            {alerts.some(a => a.type === 'biological_threat' && !a.resolved) && (
              <motion.div
                key="biological-overlay"
                ...
                <div className="w-full max-w-3xl mx-auto pointer-events-auto px-4">
                  <div className="rounded-3xl border border-rose-500/30 bg-black/90 backdrop-blur-2xl shadow-2xl overflow-hidden">
                    {/* Header */}
                    <div className="flex items-center justify-between px-6 py-4 bg-rose-500/10 border-b border-rose-500/20">
                      ...
                      <button
                        onClick={() => {
                          alerts.filter(a => a.type === 'biological_threat').forEach(a => resolveAlert(a.id))
                        }}
                    ...
                    <div className="p-6">
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="rounded-xl overflow-hidden border border-white/10 bg-black/50">
                          <img
                            src="https://images.unsplash.com/photo-1622383563227-04401ab4e5ea?w=640&h=400&fit=crop"
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            <p className="text-xs text-slate-400 uppercase tracking-wider mb-2">Symptoms</p>
                          ...
                          <div>
                            <p className="text-xs text-slate-400 uppercase tracking-wider mb-2">Actions</p>
                            <ul className="space-y-1">
                              <li className="text-sm text-emerald-300 flex items-start gap-2">
